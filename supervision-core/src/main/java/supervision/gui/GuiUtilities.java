...
public class GuiUtilities {
     ...
     * Chemin des images.
     */
    private static final String imagesPath = "supervision/gui/images/";
    /**
     * Réfrérences sur les images selon leur type.
     */
    private static final ResourceBundle images
            = ResourceBundle.getBundle("supervision.gui.commonImages");
    /**
     ...
     */
    public static Object showInputDialog(Component parent, String message,
            Object[] options, Object initValue) {
...
//                break;
    ...
    public static ImageIcon getImageIcon(String imageType, String imagesPath, ResourceBundle images) {
        ...
        try {
            ...
            Area area = new Area(new Ellipse2D.Double(offsetExt, offsetExt,
                    imagesDim - 2 * offsetExt, imagesDim - 2 * offsetExt));
            Area circle = new Area(new Ellipse2D.Double(offsetInt, offsetInt,
