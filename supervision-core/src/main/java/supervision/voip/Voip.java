...
public class Voip {
     ...
     */
    private SpeekerClient speekerClient = null;
    /**
     ...
     */
    private ListenerServer listenerPairingServer = null;
    /**
    ...
    /**
     * Initialisation du module du communication avec prise directe sur le
     * microphone.
     *
     * @param port port d'écoute pour la réception de flux audio principal.
     * @param pairingPort port d'écoute pour la réception de flux audio du
     * pairing.
     */
...
//        AudioFormat audioFormat = new AudioFormat(22050.0f, 16, 1, true, false);
    ...
    /**
     * Initialisation du module du communication avec un serveur de gestion du
     * microphone.
     *
     * @param port port d'écoute pour la réception de flux audio principal.
     * @param pairingPort port d'écoute pour la réception de flux audio du
    ...
    /**
     * Indique si les lignes sont ouvertes, c'est à dire si le système a réservé
     * les ressources et si elles sont opérationnelles.
     *
    ...
    /**
     * Connecte et démarre le client d'envoi du microphone en tant que connexion
     * du pairing à l'adresse donnée.
     *
     * @param addressIP l'adresse IP pour l'envoi du microphone.
     * @param port le port pour l'envoi du microphone.
     * @return le numéro de ligne occupée si la connexion à réussie ou sinon -1.
