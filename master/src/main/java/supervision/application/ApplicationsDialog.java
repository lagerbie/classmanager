...
//            width = 740;
        ...
        this.setLocation((screenDim.width - this.getWidth()) / 4,
    ...
    private void addApplication(Application application) {
        ...
        editButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                editDialog.showDialog(applicationsList.getApplicationWithId(fields.id));
            }
        });
    }
    ...
    /**
     * Classe recensant tous les composants graphiques nécessaires pour un
     * index.
     *
     * @version 1.90
     */
