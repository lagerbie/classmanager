...
/**
 * Event pour la pression sur la souris sur un slider.
 * Déclenche le drag du curseur du slider.
 * Affecte le slider courant (this.currentSlider).
 * Affecte l'état précédent (this.precState).
 * Affecte des listener sur la scène globale (stage) pour le mouvement,
...
/**
 * Event pour le relechement de la souris sur un slider.
 * Arrête le drag du curseur du slider.
 * Gére l'envoi de commande associée au slider courant.
 * Réinitialise le slider courant (this.currentSlider).
 * Supprime les listener sur la scène globale (stage) pour le mouvement,
 * et le relachement de la souris.
 *
 * @param event l'évènement déclencheur.
 */
