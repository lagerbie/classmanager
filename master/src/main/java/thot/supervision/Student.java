...
public class Student {
    ...
    /**
     * Retourne le nom de l'élève. Si l'élève est identifié il renvoit le login, sinon sont adresse IP.
     *
    ...
    /**
     * Modifie le statut connecté. Gére la possibilté d'avoir un ping sans réponse.
     *
