...
public class StudentClass {
     ...
     *
     * @return {@code true} si l'élève à été ajouté ou si l'adresse IP est déjà référencée.
     */
     ...
     *
     * @return l'élève suivant dans la liste ou {@code null} si il n'y pas d'élève suivant.
     */
    ...
    /**
     * Retourne l'élève sélectionné pour la diffusion suivant un autre élève. Si l'élève à partir duquel commence la
     * recherche est le dernier sélectionné pour la diffusion dans liste, on reboucle à partir du début de la liste.
     *
     * @param student l'élève à partir duquel commence la recherche.
     *
