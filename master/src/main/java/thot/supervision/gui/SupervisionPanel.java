...
public class SupervisionPanel extends TabPanel {
    ...
    public SupervisionPanel(Window parent, int width, int height, int menuWidth, int menuHeight, int buttonSize,
            int margin, Resources resources) {
        super(parent);
    ...
    private void initMenu(int menuWidth, int menuHeight, int buttonSize, int margin, Resources resources) {
        Dimension dim;
    ...
    private void initPopupMenu(Resources resources) {
        ...
        masterScreenVoiceButton = new MenuButton(GuiConstants.masterScreenVoice, masterScreenButton,
                resources.getString(GuiConstants.masterScreenVoice));
        masterVoiceButton = new MenuButton(GuiConstants.masterVoice, masterScreenButton,
                resources.getString(GuiConstants.masterVoice));
        ...
        computerPowerButton = new MenuButton(GuiConstants.computerPower, studentCloseButton,
                resources.getString(GuiConstants.computerPower));
        osSessionButton = new MenuButton(GuiConstants.osSession, studentCloseButton,
                resources.getString(GuiConstants.osSession));
        loginSessionButton = new MenuButton(GuiConstants.loginSession, studentCloseButton,
                resources.getString(GuiConstants.loginSession));
    ...
    @Override
    public void setButtonActions(ActionListener buttonListener, MouseAdapter menuButtonListener,
