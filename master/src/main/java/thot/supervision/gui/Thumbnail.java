...
public class Thumbnail extends ImagePanel {
    ...
    /**
     * Layout pour le panneau principal. Permet d'intervetir les différents composants à afficher.
     */
     ...
     *
     * @param selected {@code true} pour la sélection de groupe, ou {@code false} pour la désélection de
     *         groupe.
     */
