...
//        languageButton.addItem("Euskara");
        ...
        JPanel logo = new ImagePanel(
                GuiUtilities.getImage("logoImage", GuiConstants.imagesPath, GuiConstants.images), -1, logoHeight);
        ...
        supervisionPanel = new SupervisionPanel(this, panelWidth, panelHeight,
                menuWidth, menuHeight, buttonSize, margin, resources);
    ...
    private void initButtonActions() {
        ActionListener buttonListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                if (button.getType().contentEquals(GuiConstants.sendMessage)) {
                    String message = (String) GuiUtilities.showInputDialog(
                            button, null, resources.getString("sendText"), null, null);
                    if (message != null) {
        ...
        languageButton.addItemListener(new ItemListener() {
            @Override
    ...
    public void visuationStateChanged(Object source, int newState, int oldState) {
        String type = null;
        if (oldState == MasterCore.MOSAIQUE_MODE
                && newState == MasterCore.NORMAL_MODE) {
            type = GuiConstants.mosaique;
        } else if (oldState == MasterCore.SCANNING_MODE
                && newState == MasterCore.NORMAL_MODE) {
