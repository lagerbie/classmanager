...
public class Pastille extends JPanel {
     ...
     * Equivalant à Pastille(size, Constants.GROUP_A)
     *
     ...
     *
     * @param group le groupe affiché, il doit être de la forme suivante:
     * supervision.Constants.GROUP_A, supervision.Constants.GROUP_B, ...
     */
