...
public class LaboPanel extends TabPanel {
    ...
    public LaboPanel(LaboModule core, File userHome, File tempPath, Window parent,
        ...
        core.addListener(new LaboListener() {
            ...
            public void stateChanged(final int running, final int mediaType) {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    @Override
                    public void run() {
                        updateButtons(running, mediaType);
                    }
                });
            }
...
//                }
    ...
    private void initPanel(Window parent,
            int menuWidth, int menuHeight, int buttonSize, int margin,
            Resources resources) {
        Dimension dim;
...
//        textArea.setBorder(null);
        ...
        mediaVolume = new VolumeSlider(parent, mediaMuteButton,
...
//        });
        ...
        //anonymous listeners pour le bouton Sauvegarder du module audio
        timeMaxButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) {
