...
//    }
    ...
    public Login(StudentCore noyau, Resources resources) {
        ...
        backgroundImage = fond.getScaledInstance(dim.width, dim.height, Image.SCALE_AREA_AVERAGING);
    ...
    /**
     * Affiche la fenêtre de login. Remplace la fonction {@code setVisible(true)}.
     *
