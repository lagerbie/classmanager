...
public class WindowsUtilities {
    ...
    private static void loadDll() {
        ...
        try {
            utilitiesDll = (UtilitiesDll) Native.loadLibrary(dllName,
                    UtilitiesDll.class, UtilitiesDll.DEFAULT_OPTIONS);
        } catch (UnsatisfiedLinkError e) {
            LOGGER.error("", e);
            utilitiesDll = null;
        }

        user32Dll = (User32Dll) Native.loadLibrary("User32", User32Dll.class);
    }
