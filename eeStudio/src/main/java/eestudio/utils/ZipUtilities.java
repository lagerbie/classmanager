...
/*
 * v0.95: modif de streamCopy(..) [read plus dans le test de while]
 * 
 * v0.96: modif de unzipFileIntoDirectory(..) [gestion mémoire]
 * v0.96: modif de fileToZip(File, File, boolean) [variable boucle for]
 * v0.96: modif de fileToZip(File, ZipOutputStream, File) [variable boucle for]
 */
...
public class ZipUtilities {
    ...
    }//end unzipFileIntoDirectory(File srcFile, File directory)
    ...
    }//end fileToZip(File file, File zipFile, boolean compression)
