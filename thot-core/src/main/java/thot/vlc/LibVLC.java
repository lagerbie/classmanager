 ...
 * @version 2.1.4 (VLC 1.1.x à 2.1.x et compatible JET)
 */
public interface LibVLC extends Library {
     ...
     *         <p>
     *         begincode \@protocol VLCOpenGLVideoViewEmbedding <NSObject> - (void)addVoutSubview:(NSView *)view; -
     *         (void)removeVoutSubview:(NSView *)view; \@end endcode Or it can be an NSView object.
     *         <p>
     ...
     *         QMacCocoaViewContainer(video, parent); libvlc_media_player_set_nsobject(mp, video); [video release]; }
