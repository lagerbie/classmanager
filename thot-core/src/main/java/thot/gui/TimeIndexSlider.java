...
//    private ImageIcon playIndex;
     ...
     */
    public TimeIndexSlider(final IndexProcessing core, final Window owner,
            Resources resources, int width) {
        this.owner = owner;
        this.core = core;
            ...
            public void mouseClicked(MouseEvent event) {
                if (isEnabled() && SwingUtilities.isLeftMouseButton(event)
                    ...
                    if (core.getRunningState() == Constants.PAUSE
                        ...
                        studentMenu.getPopupMenu().show(event.getComponent(),
