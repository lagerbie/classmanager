...
public class ScreenWindow implements Runnable {
     ...
     */
    private static final boolean LINUX_PLATFORM
     ...
     */
    public void start(String addressIP, int port, int nbLines, String nom,
...
//            window.toFront();
    ...
    private boolean connectReception() throws IOException {
        ...
        CommonLogger.debug("connection reception to addressIP:" + addressIP
                + " port:" + receptionPort);
        ...
        try {
            ...
            CommonLogger.debug("...reception etablished");
            connected = true;
        } catch (SocketTimeoutException e) {
            CommonLogger.warning("Err connectReception dans ScreenWindow: " + e);
        }
        return connected;
    }
    ...
    private void disconnectReception() {
        if (socketReception != null) {
            try {
                ...
                CommonLogger.warning("Err disconnectReception dans ScreenWindow: " + e);
                CommonLogger.error(e);
            }
        }
    }
    ...
    private long analyseJpeg() {
        ...
        try {
            ...
            while (header >= 0) {
                ...
                if (tracker.getErrorsID(0) == null) {
                    ...
                    for (Object object : erors) {
                        CommonLogger.warning("err in track :" + object);
                    }
                }
            ...
            CommonLogger.debug("ScreenWindow timeout: " + timeout);
            end = -1;
        } catch (IOException e) {
    ...
    public void run() {
        ...
        CommonLogger.info("global: " + timeGlobal / secondToNano
                + " transfert: " + timeTransfert / secondToNano
                + " passe: " + passe);
        if (passe > 0) {
            CommonLogger.info("global: " + timeGlobal / secondToNano / passe
                    + " transfert: " + timeTransfert / secondToNano / passe);
        }
